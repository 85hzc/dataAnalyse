...
class Process_Data:
    ...
    def Process_init(self):
        ...
        #####################################################################################
        self.myfont = matplotlib.font_manager.FontProperties(fname='C:\Windows\Fonts\simsun.ttc')
    ...
    def Ex_Rank_Type(self):
        ...
        for types, movies in self.processed_type.items():
            ...
            movies.to_csv('../Datas/RankByType/' + \
    ...
    def Ex_Rank_Region(self):
        ...
        for regions, movies in self.processed_region.items():
            ...
            # mode='a' means append
            # index=False, do not store the index
            movies.to_csv('../Datas/RankByRegion/' + \
...
if __name__ == '__main__':
    ...
    pp = Process_Data('../Datas/SourceData/data.csv')
    pp.Process_init()
    pp.Rank_Type()
    pp.Rank_Region()
